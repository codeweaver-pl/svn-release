...
function ReleaseUtils(svn) {
  this.svn = svn;
}

ReleaseUtils.prototype.setVersion = setVersion;

ReleaseUtils.prototype.loadPackageJson = setVersion;

ReleaseUtils.prototype.storePackageJson = setVersion;

ReleaseUtils.prototype.branchUrl = branchUrl;

ReleaseUtils.prototype.tagUrl = tagUrl;

ReleaseUtils.prototype.noLocalChanges = function () {
  return failOnChanges(this.svn);
};
